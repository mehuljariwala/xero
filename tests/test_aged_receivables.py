"""
E2E tests for Aged Receivables Detail report workflow.
"""
import pytest
...
@pytest.mark.e2e
class TestAgedReceivablesWorkflow(BaseWorkflowTest):
    WORKFLOW_NAME = "aged_receivables_detail"
    WORKFLOW_FILE = "aged_receivables_detail.yaml"
    REPORT_SEARCH_TERM = "Aged Receivables Detail"
